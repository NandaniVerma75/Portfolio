      ...
      <Card.Body>
        <blockquote className="blockquote mb-0">
          <p style={{ textAlign: 'justify', fontSize: '1.1em' }}>
            Greetings, fellow tech enthusiasts! I'm <span className="purple">Nandani</span>, 
            hailing from the bustling metropolis of <span className="purple">Jharkhand, India</span>.
            <br />
            <br />
